...
{
	// Result can be SIZE+1 in memory
...
void mp_subtraction(unsigned char *res, unsigned char *in1, unsigned char *in2)
{
	...
	// Result is SIZE bytes in memory
	unsigned short s1;
	unsigned short s2;
	signed short r = 0;
	unsigned short c = 0;
...
void mod_addition(unsigned char *res, unsigned char *in1, unsigned char *in2)
{
	// You can use n directly as global variable, i.e. without passing it as pointer
	
}

void mod_subtraction(unsigned char *res, unsigned char *in1, unsigned char *in2)
{
	// You can use n directly as global variable, i.e. without passing it as pointer
